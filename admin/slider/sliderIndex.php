...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Slider Index <small>it all starts here</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
            ...
            <span><a href="addSlider.php" class="btn btn-primary btn-sm">
            <span class="glyphicon glyphicon-plus"></span> Add slider</a>
