      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" style="color:#ddd;" class="btn btn-box-tool btn-primary" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i>
            </button>
            <button type="button" style="color:#ddd;" class="btn btn-box-tool btn-primary" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i>
            </button>
          </div>
        </div>
        <div class="box-body">
        <h4>Dynamic photo gallery contains
          <?php
          $db = new Gallery;
          $stmt = 'SELECT * FROM tbl_gallery';
          ?>
          <span class="badge badge-pill badge-primary">
            <?php $db->count($stmt);?></span> photos</h4>
          <hr>
          <table class="table table-responsive table-condensed">
            <tbody>
              ...
              $db = new Gallery;
              $stmt = 'SELECT * FROM tbl_gallery WHERE id=:id';
