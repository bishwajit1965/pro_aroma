  ...
  <body id="login">
    <div class="container">
      ...
      <form class="form-signin" method="post"">
        ...
        <a href="index.php" style="float:right;" class="btn btn-large btn-success">Sign In</a>
      </form>

    </div> <!-- /container -->
    <script src="bootstrap/dist/jquery/dist/jquery.min.js"></script>
    <script src="bootstrap/disi/js/bootstrap.min.js"></script>
  </body>
</html>
