        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="tag_index.php" class="btn btn-primary btn-sm"> <span class="glyphicon glyphicon-list"></span> Tag Index</a>
              ...
              $msg = '<div class="row">
                <div class="col-md-12">
                  <div class="alert alert-warning alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong id= "strong"#9C0A0A>WARNING!!! ERROR!! tag is not inserted!</strong>
                  </div>
                </div>
              </div>';
              echo $msg;
