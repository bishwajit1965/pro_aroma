    ...
    <div class="wrapper">
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
                ...
                <a href="tag_index.php" class="btn btn-primary btn-sm"> <span class="glyphicon glyphicon-plus"></span> Tag Index</a>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <strong id= "strong"#9C0A0A> DELETE!!! Will you delete the data!! Are you sure of it ?</strong>&nbsp &nbsp
                    </div>
                </div>
                </div>
                <?php
                ...
                <?php
                $db = new Tag();
                $query = "SELECT * FROM  tbl_tag WHERE tag_id = :tag_id";
                $db->deleteView($query);
                ?>
            </div>
            <!-- /.box-body -->
