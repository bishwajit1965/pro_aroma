  ...
  <?php include_once('../partials/_head.php');?>
    ...
    <div class="wrapper">
        ...
        <section class="content-header">
            <h1>Delete copyright<small>it all starts here</small></h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
                ...
                <span class="glyphicon glyphicon-plus"></span> Copyright home</a>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <strong id= "strong"#9C0A0A> DELETE!!! Will you delete the data!! 
                        Are you sure of it ?</strong>&nbsp &nbsp
                        </div>
                        <?php
                        if (isset($_GET['not-deleted'])) {
                            echo
                            '<div class="alert alert-danger alert-dismissible"  role="alert">
                                ...
                                Footer text is not deleted succssfully!
                                </strong>&nbsp &nbsp
                            </div>';
                        }
                        ?>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST['btn-delete'])) {
                        $id = $_GET['delCopyright_id'];
                        $copyright = $_POST['copyright'];
                        $db->delete($id, $copyright);
                    }
                }
                ?>
                <?php
