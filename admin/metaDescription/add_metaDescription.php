                        ...
                        if ($description =="") {
                            ...
                            '<div class="row">
                                <div class="col-md-12">
                                    ...
                                    Description field remained blank! Fill up the field and try again!</strong>
                                    </div>
                                </div>
                            </div>';
                            echo $msg;
                        } elseif ($db->createMetaDescription($description)) {
                            $msg =
                            '<div class="row">
                                <div class="col-md-12">
                            ...
                            $msg =
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span></button>
                                    <strong id= "strong"#9C0A0A>WARNING!!! ERROR!! Description is not inserted!</strong>
                                    </div>
                                </div>
                            </div>';
                            echo $msg;
