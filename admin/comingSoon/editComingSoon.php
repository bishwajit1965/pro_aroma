...
<!-- Site wrapper -->
    ...
    <div class="content-wrapper">
        ...
        <h1>
            Edit slider photo <small>it all starts here</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="box">
            ...
            <a href="comingSoonIndex.php" class="btn btn-primary btn-sm">
                <span class="glyphicon glyphicon-plus"></span> Coming soon index</a>
                Dynamic slider gallery contains
            <?php
            $db = new ComingSoon();
            $stmt = 'SELECT * FROM tbl_coming_soon';
            ?>
            <span class="badge badge-pill badge-primary">
            <?php $db->count($stmt); ?></span> photo(s)</span>

            <!-- <h3 class="box-title">Title</h3> -->
            <div class="box-tools pull-right">
                <button type="button" style="color:#ddd;"
                class="btn btn-box-tool btn-primary" data-widget="collapse" data-toggle="tooltip" title="Collapse">
            ...
            <table class="table table-responsive table-condensed">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST['btn-edit'])) {
                        ...
                        <?php
                            ...
                            $db->updateWithoutPhoto($id, $title, $description, $published_at); ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <?php
                            ...
                            $db->updateComingSoon($id, $title, $photo, $description, $published_at);
                ...
                // Slider photo fetched to display
                $db = new ComingSoon();
                $stmt = 'SELECT * FROM tbl_coming_soon WHERE id=:id';
                $db->editComingSoonView($stmt); ?>
                </tbody>
            </table>
            </div>
            <!-- /.box-body -->
