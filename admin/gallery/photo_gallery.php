    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <h4><a href="add_photo.php" class="btn btn-primary btn-sm">
          <span class="glyphicon glyphicon-plus"></span> Add photo</a>
          Dynamic photo gallery contains
            <?php
            $db = new Gallery;
            $query = 'SELECT * FROM tbl_gallery';
            ?>
            <span class="badge badge-pill badge-primary">
                <?php $db->count($query);?></span> photos</h4>
